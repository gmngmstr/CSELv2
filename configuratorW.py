...
vulnerability_template = {"Disable Guest": {"Definition": 'Enable this to score the competitor for disabling the Guest account.',
                          ...
                          "Disable Root": {"Definition": 'Enable this to score the competitor for disabling the Administrator account.',
                                            "Category": 'Account Management'},
 ...
 #"Update Program": {"Definition": '(WIP)Enable this to score the competitor for updating a program.',
                          ...
                          "Update Check Period": {"Definition": 'What has the update check period been set to? (apt/apt.conf.d/10periodic) \nPlease set Occurance as [minute] [hour] [day of month] [month] [day of week]',
                                            "Category": 'Program Management'},
                          "Update Auto Install": {"Defintion": 'Automaticaly download and install security updates',
                                                  "Category": 'Program Management'},
